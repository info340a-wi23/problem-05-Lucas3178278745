...
let result = motto.indexOf('cool');
let boolean = (result === 0);
console.log(boolean);
...
let update = motto.replace('iSchool', 'Information School');
motto = update;
console.log(motto);
...
let updatedLength = motto.length;
let ratio = ((updatedLength / mottoLength) * 100).toFixed(2) + '%';
console.log(ratio);
...
console.log(shapes[2].hypotenuse); //I got undefined.
...
console.log(shapes); //The hypotenuse property of the triangle is updated.
